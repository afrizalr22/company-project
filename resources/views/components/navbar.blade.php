<nav id="navbar" class="bg-blue-500 p-[20px_30px] rounded-[20px] transition-all duration-500 ease-in-out z-50">
    ...
    <div class="flex flex-wrap items-center justify-between gap-y-3 max-w-[1130px] mx-auto">
        ...
        <ul class="flex flex-wrap items-center gap-[50px] mx-auto text-white">
            <li
                class="{{ request()->routeIs('front.index') ? 'text-white' : '' }} font-semibold hover:text-blue-950 transition-all duration-300">
            ...
            <li id="layanan-menu" class="relative font-semibold transition-all duration-300 group">
                ...
                <ul id="layanan-dropdown"
                    ...
                    <li><a href="#" class="block px-4 py-2 hover:bg-cp-light-blue hover:text-blue-950">IT
                            Solutions</a></li>
                    <li><a href="#" class="block px-4 py-2 hover:bg-cp-light-blue hover:text-blue-950">Support &
                            Maintenance</a></li>
                    <li><a href="#" class="block px-4 py-2 hover:bg-cp-light-blue hover:text-blue-950">Pembuatan
                            Website</a></li>
                </ul>
            </li>

            <li
                class="{{ request()->routeIs('front.team') ? 'text-cp-dark-blue' : '' }} font-semibold hover:text-blue-950 transition-all duration-300">
                <a href="{{ route('front.team') }}">Gallery</a>
            </li>
            <li
                class="{{ request()->routeIs('front.blog') ? 'text-cp-dark-blue' : '' }} font-semibold hover:text-blue-950">
                <a href="">Blog</a>
            </li>
            <li
                class="{{ request()->routeIs('front.about') ? 'text-cp-dark-blue' : '' }} font-semibold hover:text-blue-950 transition-all duration-300">
